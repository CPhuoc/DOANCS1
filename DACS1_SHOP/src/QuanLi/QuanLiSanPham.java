...
public class QuanLiSanPham extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    QuanLiSanPham frame = new QuanLiSanPham();
    ...
    public QuanLiSanPham() {
        ...
        lblNewLabel_3.setBounds(33, 0, 184, 38);
        panel_5.add(lblNewLabel_3);
        
        JLabel lblNewLabel_4 = new JLabel("");
        lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\NITRO 5\\Downloads\\icons8-product-24.png"));
        lblNewLabel_4.setBounds(4, 0, 48, 38);
        panel_5.add(lblNewLabel_4);
        
        JButton btnNewButton_4_1 = new JButton("Sửa");
        btnNewButton_4_1.setBackground(new Color(255, 166, 0));
        btnNewButton_4_1.setFont(new Font("Tahoma", Font.PLAIN, 15));
        btnNewButton_4_1.setIcon(new ImageIcon("C:\\Users\\NITRO 5\\Downloads\\icons8-fix-24.png"));
        btnNewButton_4_1.setBounds(20, 58, 127, 45);
        panel_3.add(btnNewButton_4_1);
        
        JButton btnNewButton_4_2 = new JButton("Xóa");
        btnNewButton_4_2.setBackground(new Color(255, 255, 0));
        btnNewButton_4_2.setFont(new Font("Tahoma", Font.PLAIN, 15));
        btnNewButton_4_2.setIcon(new ImageIcon("C:\\Users\\NITRO 5\\Downloads\\icons8-delete-24.png"));
        btnNewButton_4_2.setBounds(186, 58, 127, 45);
        ...
        btnNewButton_4_3.setBounds(348, 58, 127, 45);
